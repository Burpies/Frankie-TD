...
--[[
  ...
  See FrankieTD:PostLoadPrecache() in frankietd.lua for more information
  ]]

  DebugPrint("[FRANKIETD] Performing pre-load precache")
  ...
  PrecacheUnitByNameSync("captain_frankie", context)
  PrecacheUnitByNameSync("fire_minion", context)
  PrecacheUnitByNameSync("sheep", context)
  PrecacheUnitByNameSync("pigs", context)
end

-- Create the game mode when we activate
function Activate()
  GameRules.FrankieTD = FrankieTD()
  GameRules.FrankieTD:_InitFrankieTD()
end
