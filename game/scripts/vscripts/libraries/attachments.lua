...
--[[
  ...
  -Ensure that you have the frankietd_attachments.xml, frankietd_attachments.js, and frankietd_attachments.css files in your panorama content folder to use the GUI.
  -Ensure that frankietd_attachments.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/frankietd_attachments.xml" />
