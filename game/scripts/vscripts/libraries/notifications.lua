...
--[[
  ...
  -Ensure that you have the frankietd_notifications.xml, frankietd_notifications.js, and frankietd_notifications.css files in your panorama content folder.
  -Ensure that frankietd_notifications.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/frankietd_notifications.xml" />
